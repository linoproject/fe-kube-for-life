/**
 * @class Application_WidgetButton
 * 
 * @description Button widget fire action on click and optionally handle the return data
 * 
 * @param x-lprjvar-action Widet_param to fire when button is pressed
 * @param x-lprjvar-return 
 * 
<example>
